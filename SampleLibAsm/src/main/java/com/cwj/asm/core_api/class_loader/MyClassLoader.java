...
public class MyClassLoader extends ClassLoader {
    ...
    byte[] generatingClass() throws IOException {
        ...
        File file = new File("/Users/yannischeng/JetBrain_Projects/Projects_IDEA_Java/NoahArkA/SampleLibAsm/src/main/java/com/cwj/asm/out_file/ExampleInterface.class");
        if (file.exists()) {
            if (file.delete()) {
