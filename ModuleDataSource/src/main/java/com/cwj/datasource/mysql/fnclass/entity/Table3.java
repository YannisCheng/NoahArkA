...
@Entity
@Table(name = "table_3")
@ApiModel(value = "Table3", description = "行政4班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_3", comment = "行政4班级表")
/**
 * 行政4班级表(Table3)实体类
 *
 * @author WenjiaCheng
...
public class Table3 implements Serializable {
    ...
    private static final long serialVersionUID = -46659416395342451L;
