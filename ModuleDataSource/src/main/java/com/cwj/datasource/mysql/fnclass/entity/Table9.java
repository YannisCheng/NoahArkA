...
@Entity
@Table(name = "table_9")
@ApiModel(value = "Table9", description = "行政10班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_9", comment = "行政10班级表")
/**
 * 行政10班级表(Table9)实体类
 *
 * @author WenjiaCheng
...
public class Table9 implements Serializable {
    ...
    private static final long serialVersionUID = -53862081284113726L;
