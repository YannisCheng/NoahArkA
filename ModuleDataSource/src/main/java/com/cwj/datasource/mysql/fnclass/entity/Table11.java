...
@Entity
@Table(name = "table_11")
@ApiModel(value = "Table11", description = "行政12班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_11", comment = "行政12班级表")
/**
 * 行政12班级表(Table11)实体类
 *
 * @author WenjiaCheng
...
public class Table11 implements Serializable {
    ...
    private static final long serialVersionUID = -89920225056685546L;
