...
@Entity
@Table(name = "table_5")
@ApiModel(value = "Table5", description = "行政6班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_5", comment = "行政6班级表")
/**
 * 行政6班级表(Table5)实体类
 *
 * @author WenjiaCheng
...
public class Table5 implements Serializable {
    ...
    private static final long serialVersionUID = 754315150383739065L;
