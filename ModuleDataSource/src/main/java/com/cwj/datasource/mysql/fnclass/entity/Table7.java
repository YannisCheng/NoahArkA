...
@Entity
@Table(name = "table_7")
@ApiModel(value = "Table7", description = "行政8班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_7", comment = "行政8班级表")
/**
 * 行政8班级表(Table7)实体类
 *
 * @author WenjiaCheng
...
public class Table7 implements Serializable {
    ...
    private static final long serialVersionUID = -66226235639163787L;
