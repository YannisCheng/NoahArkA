...
public interface Table3Service {
     ...
     * @return 实例对象
     */
    Optional<Table3> findById(Integer id);
     ...
     * @return 分页数据
     */
    Page<Table3> findByPage(Pageable pageable);
     ...
     * @return 实例对象
     */
    Optional<Table3> findByIdCard(String idCard);
     ...
     * @return 保存后的对象
     */
    Table3 updateByObj(Table3 table3);
