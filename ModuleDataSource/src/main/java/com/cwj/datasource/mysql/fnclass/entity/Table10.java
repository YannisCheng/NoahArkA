...
@Entity
@Table(name = "table_10")
@ApiModel(value = "Table10", description = "行政11班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_10", comment = "行政11班级表")
/**
 * 行政11班级表(Table10)实体类
 *
 * @author WenjiaCheng
...
public class Table10 implements Serializable {
    ...
    private static final long serialVersionUID = -39409513410289361L;
