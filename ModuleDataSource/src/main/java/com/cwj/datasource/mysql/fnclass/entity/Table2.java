...
@Entity
@Table(name = "table_2")
@ApiModel(value = "Table2", description = "行政3班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_2", comment = "行政3班级表")
/**
 * 行政3班级表(Table2)实体类
 *
 * @author WenjiaCheng
...
public class Table2 implements Serializable {
    ...
    private static final long serialVersionUID = -84649073890301753L;
