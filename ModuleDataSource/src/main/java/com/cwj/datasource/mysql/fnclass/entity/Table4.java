...
@Entity
@Table(name = "table_4")
@ApiModel(value = "Table4", description = "行政5班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_4", comment = "行政5班级表")
/**
 * 行政5班级表(Table4)实体类
 *
 * @author WenjiaCheng
...
public class Table4 implements Serializable {
    ...
    private static final long serialVersionUID = 447082120767387097L;
