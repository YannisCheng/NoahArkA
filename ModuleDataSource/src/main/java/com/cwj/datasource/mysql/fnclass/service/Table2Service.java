...
public interface Table2Service {
     ...
     * @return 分页数据
     */
    Page<Table2> findByPage(Pageable pageable);
     ...
     * @return 实例对象
     */
    Optional<Table2> findByIdCard(String idCard);
     ...
     * @return 保存后的对象
     */
    Table2 updateByObj(Table2 table2);
