...
@Entity
@Table(name = "table_6")
@ApiModel(value = "Table6", description = "行政7班级表")
@EntityListeners(AuditingEntityListener.class)
@org.hibernate.annotations.Table(appliesTo = "table_6", comment = "行政7班级表")
/**
 * 行政7班级表(Table6)实体类
 *
 * @author WenjiaCheng
...
public class Table6 implements Serializable {
    ...
    private static final long serialVersionUID = -24394207410951336L;
