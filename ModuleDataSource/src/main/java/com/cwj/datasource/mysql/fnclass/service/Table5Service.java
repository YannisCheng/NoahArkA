...
public interface Table5Service {
     ...
     * @return 实例对象
     */
    Optional<Table5> findById(Integer id);
     ...
     * @return 分页数据
     */
    Page<Table5> findByPage(Pageable pageable);
     ...
     * @return 实例对象
     */
    Optional<Table5> findByIdCard(String idCard);
     ...
     * @return 保存后的对象
     */
    Table5 updateByObj(Table5 table5);
